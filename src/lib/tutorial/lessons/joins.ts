...
import { criterion, hasTable, hasColumn, hasJoinOn, hasJoinType } from "../criteria";
  ...
  challenges: [
    ...
    },
    {
      ...
      criteria: [
        ...
        criterion("has-category-name", "Select categories.name", hasColumn("categories", "name")),
      ],
    },
    {
      id: "joins-3",
    ...
    },
    {
      ...
      criteria: [
        ...
        criterion(
          ...
          hasColumn("order_items", "quantity"),
        ),
      ],
    },
  ],
