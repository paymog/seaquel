...
import { criterion, hasTable, hasGroupBy, hasHavingComparison, hasFilter } from "../criteria";
  ...
  challenges: [
    {
      ...
      criteria: [
        ...
        criterion("has-having", "HAVING COUNT(*) > 3", hasHavingComparison("COUNT", ">", "3")),
      ],
    },
    {
      id: "having-2",
      ...
      criteria: [
        ...
        criterion("has-having", "HAVING AVG(...) > 75", hasHavingComparison("AVG", ">", "75")),
      ],
    },
    {
      id: "having-3",
      ...
      criteria: [
        ...
        criterion("has-having", "HAVING COUNT(*) >= 2", hasHavingComparison("COUNT", ">=", "2")),
      ],
    },
    {
      id: "having-4",
      ...
      criteria: [
        criterion("has-products", "Query the products table", hasTable("products")),
        criterion("has-where", "WHERE price > 20", hasFilter("products.price", ">", "20")),
        criterion(
          "has-group-by",
          "Group by products.category_id",
          hasGroupBy("products.category_id"),
    ...
    },
    {
      ...
      criteria: [
        ...
        criterion("has-having", "HAVING SUM(...) > 500", hasHavingComparison("SUM", ">", "500")),
      ],
    },
  ],
};
