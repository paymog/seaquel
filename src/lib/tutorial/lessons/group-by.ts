...
import { criterion, hasTable, hasColumn, hasGroupBy } from "../criteria";
...
In the query builder, use the GROUP BY section in the filter panel to add grouping columns.
  ...
  challenges: [
    ...
    },
    {
      ...
      description:
        "Group customers by their country to see how many countries you have customers in.",
    ...
    },
    {
      ...
      description:
        "Show all products grouped by category, displaying both the category_id and product name.",
