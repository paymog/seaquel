...
Window functions are powerful for rankings, running totals, and comparisons.
  ...
  challenges: [
    ...
    },
    {
      ...
      description: "For each product, show its price and the average price in its category.",
    ...
    },
    {
      id: "window-5",
      title: "Dense Ranking",
      description: "Use DENSE_RANK to rank customers by their total order count (highest first).",
